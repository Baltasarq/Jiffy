...
public class Html extends Templater {
    private final static String VAR_STORY_FILE = "$(STORY_FILE)";
    private final static String VAR_STORY_ID = "$(STORY_ID)";
    private final static String VAR_STORY_UUID = "$(STORY_UUID)";
    ...
    public String subst()
    {
        ...
        SUBSTS.putAll(
                Map.of( 
                    VAR_STORY_FILE, this.TARGET_FILE_NAME,
                    VAR_STORY_ID, ENT_STORY.getId().get(),
                    VAR_STORY_UUID, ENT_STORY.getIfId().toString() ));
    ...
    private void initDefaultSubsts()
    {
        ...
        DEFAULT_SUBSTS.putAll(
                        Map.of(
                                VAR_STORY_FILE, "error",
                                VAR_STORY_ID, "ERROR",
                                VAR_STORY_UUID, "123-ebb0b-456" ));
    }
